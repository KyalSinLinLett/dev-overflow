                            ...
                            <li class="nav-item dropdown"> 
                                <!-- Dropdown -->
                                  <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">
                                    Groups 
                                    @if(Auth::user()->unreadNotifications()->where('type', "App\Notifications\join_request_approved")->get()->count() > 0 || Auth::user()->unreadNotifications()->where('type', "App\Notifications\send_pub_invite_noti")->get()->count() > 0)
                                  ...
                                  <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="{{ route('group.noti') }}">Groups notifications: <small class="text-light px-2 py-1" style="background-color: red; border-radius: 50%;"><strong>{{ Auth::user()->unreadNotifications()->where('type', "App\Notifications\join_request_approved")->get()->count() +  Auth::user()->unreadNotifications()->where('type', "App\Notifications\send_pub_invite_noti")->get()->count() }}</strong></small></a>
                                  </div>
                                </li>
                            </li>
                            <li class="nav-item">
